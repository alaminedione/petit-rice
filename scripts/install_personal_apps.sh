...
# Package definitions
declare -A PACKAGES
PACKAGES["extras"]="freedownloadmanager firefox gpu-screen-recorder-gtk pipes.sh onlyoffice-bin atril cheese meld clapper viewnior gst-plugin-bad gst-plugin-ugly gst-libav"
PACKAGES["personal"]="cloudflare-warp-bin  drawio-desktop brave-bin telegram-desktop   macchanger megasync-bin turso docker docker-compose podman"
