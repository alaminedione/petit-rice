...
# sway
sed -i "s|^include ./themes/.*|include ./themes/everforest-dark|" ~/.config/sway/config

# hyprland
cp ~/.config/hypr/themes/everforest-dark.conf ~/.config/hypr/colors.conf

# foot
sed -i "s|^include=~/.config/foot/themes/.*|include=~/.config/foot/themes/everforest-dark.ini|" ~/.config/foot/foot.ini

# wofi
cp ~/.config/wofi/themes/everforest-dark-medium.css ~/.config/wofi/style.css

# waybar sway
cp ~/.config/hypr/waybar/themes/everforest-dark-medium.css ~/.config/sway/waybar/style.css

# waybar hyprland
cp ~/.config/hypr/waybar/themes/everforest-dark-medium.css ~/.config/hypr/waybar/style.css
...
# gsettings
gsettings set org.gnome.desktop.interface icon-theme "Vimix-beryl"
...
kvantummanager --set KvArcDark # No everforest theme for kvantum in scripts

#rmpc
sed -i 's|theme:Some.*|theme:Some(\"everforest\"),|' ~/.config/rmpc/config.ron

echo "Everforest Dark theme applied successfully!"
