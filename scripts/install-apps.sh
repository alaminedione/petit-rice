...
PACKAGES["dev"]="github-cli  nodejs pnpm npm python python-pip cargo go onefetch cloc typescript lazygit sccache ccache uv ts-node lazydocker-bin croc php composer hyperfine yq rust  rust-src rust-analyzer"
